...
public class MatrixAddition2D {
  ...
  private static void matrixAddition(
      Matrix2DFloat A, Matrix2DFloat B, Matrix2DFloat C, final int size) {
  ...
  private static void matrixAddition(
      Matrix2DFloat4 A, Matrix2DFloat4 B, Matrix2DFloat4 C, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (@Parallel int j = 0; j < size; j++) {
  ...
  public static void main(String[] args) {
    ...
    TaskGraph taskGraph1 =
        new TaskGraph("s1") //
            ...
            .task(
                "t1",
                MatrixAddition2D::matrixAddition,
                matrixAV,
                matrixBV,
                matrixCV,
                (size * 2)) //
    ...
    double speedupVector =
        (double) (endSequential - startSequential) / (double) (endVector - startVector);

    System.out.println(
        "\tCPU Sequential Total Time = " + (endSequential - startSequential) + " ns");
